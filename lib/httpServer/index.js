    ...
    constructor(node, blockchain, operator, miner) {
        ...
        const projectWallet = (wallet) => {
            return {
                ...
                studentId: wallet.studentId || null  // 添加学生ID，如果不存在则为null
            };
        };
        ...
        this.app.get('/blockchain/signin-info', (req, res) => {
            res.status(200).send(blockchain.getSignInInfo());
        });
